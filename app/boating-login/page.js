...
export default function Home() {
  ...
  const signIn = async (redirectPath = '/boating') => {
      ...
      <div className={styles.loginPage}>
        <div className={styles.content}>
          <header className={styles.header}>
            <h1>Welcome Back</h1>
            <h5>
              Securely access the control panel to manage tickets and view
              analytics. Your gateway to streamlined management and oversight.
            </h5>
          </header>
          <button
            onClick={() => signIn()}
